...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Remainder.user'
        db.add_column('tracker_remainder', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Remainder.user'
        db.delete_column('tracker_remainder', 'user_id')
    ...
    models = {
        ...
        'tracker.product': {
            ...
            'notify_me': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
